# Ben Flanders — Factual Reference

> **Purpose:** This file is the single source of truth for biographical and professional facts about Ben Flanders. Any agent or contributor modifying the website **must** cross-reference this document and **must not** fabricate, embellish, or assume details that are not listed here.

---

## Identity

- **Full name:** Benjamin Robert Flanders
- **Goes by:** Ben Flanders
- **Email:** Benrflanders@gmail.com
- **Location:** Atlanta, GA
- **Personal website:** https://benflanders.me
- **GitHub:** https://github.com/Benrflanders
...
|--------|-------|-------------|------|
| B.S. | Computer Science | University of Georgia (UGA) | 2019 |
...
- NPS reference: https://www.nps.gov/articles/secn-august19-newsletter.htm
...
- SQL (Transact-SQL)
- Amazon Web Services (SQS, SageMaker, EC2, S3, Amplify, and more)
- Strands (AI) — agentic AI framework
- Prompt engineering & context engineering

### Frameworks & Libraries
- Strands (AI), LangChain (Python)
- TensorFlow, Keras
- Django REST Framework
- React, Next.js
- NumPy, Scikit-Learn, SciPy (signal processing)
...
1. **Patent:** "Automated weighting generation for three-dimensional models" — https://patents.justia.com/inventor/benjamin-robert-flanders
2. **Thesis:** "Automated Bird Audio Classification using Machine Learning" (M.S., UGA, 2021) — https://www.ai.uga.edu/sites/default/files/inline-files/theses/flanders_benjamin_202105_ms.pdf
3. **Paper:** SkiNNer paper (published 2021, not yet on publisher's site).

---

## Articles & Blog Posts

- "Ben's take on Stripe" — https://www.artimatic.io/post/three-reasons-i-love-using-stripe
